...
Labelmap = [' '] + readTxt('/work/ocr/pro/CommonOCR/model/OCR/drivinglicense_nameadds_wordslib.txt')
...
def parse_args():
    ...
    parser.add_argument('--model_def',
                        default='/work/ocr/pro/CommonOCR/model/OCR/drivinglicense_nameadds_deploy.prototxt')
    ...
    parser.add_argument('--model_weights',
                        default='/work/ocr/pro/CommonOCR/model/OCR/drivinglicense_nameadds.caffemodel')
...
def main():
    img_dir = '/work/ocr/pro/CommonOCR/tmp'
