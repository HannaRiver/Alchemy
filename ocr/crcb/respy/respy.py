...
if __name__ == '__main__':
    ...
    # make label file
    respy2label('/work/hena/ocr/data/HandWriting/bill/CRCB/crcb_shred/spy/0712/train_label_03.caffemodel', '/work/hena/ocr/data/HandWriting/bill/CRCB/crcb_shred/spy/CRCB_0712.txt')
    pass
